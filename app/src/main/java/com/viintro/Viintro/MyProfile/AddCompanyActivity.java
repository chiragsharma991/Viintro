...
public class AddCompanyActivity extends Activity {
    private EditText edt_companies;
    ...
    {
        edt_companies = (EditText) findViewById(R.id.edt_companies);
        text_char_left = (TextView) findViewById(R.id.text_char_left);
        img_close = (ImageView) findViewById(R.id.img_close);
        btn_saveInfo = (Button) findViewById(R.id.btn_saveInfo);

        if(getIntent().getExtras() != null) {
            String cmpny = getIntent().getExtras().getString("cmpny");
            if (!(cmpny == null)) {
                edt_companies.setText(cmpny);
            }
        }

        edt_companies.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        btn_saveInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(CommonFunctions.chkStatus(mContext))
                {
                    ...
                    req_add_companies_API(mContext);
    ...
    // API Call to send company details
    public void req_add_companies_API(final Context cont)
    {
        ...
        String url = m_config.web_api_link+ "/add-companies";
        ...
        try
        {
            ...
            obj.put("companies", edt_companies.getText().toString().replaceAll("\\s+", " ").trim());  //m_config.profile_website
        ...
        JsonObjectRequest getRequest = new JsonObjectRequest(Request.Method.POST, url, obj,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        CommonFunctions.hDialog();
                        CommonFunctions.displayToast(context,"Company details has been saved");
                        SharedPreferences.Editor editor = sharedPreferences.edit();
                        if(sharedpreferences.getString("profile_companies_list",null) == null)
                        {
                        ...
                        String companies = edt_companies.getText().toString().replaceAll("\\s+", " ").trim();
                        editor.putString("profile_companies_list",companies);
                        editor.commit();
//                        profile_companies_list = new ArrayList();
//                        profile_companies_list.add(Arrays.asList(companies.split(",")));
                        Intent resultIntent = new Intent();
                        resultIntent.putExtra("company", companies);
                        ...
                        if(error.networkResponse != null)
                        {
                            ...
                            if(networkresponse_data != null)
                            {
                                ...
                                catch (JSONException e)
                                {
                                    ...
                                    CommonFunctions.displayToast(context,context.getResources().getString(R.string.Companies_details_failed));
                                }
        ...
        ViintroApplication.getInstance().addToRequestQueue(getRequest, "add_companies_api");
