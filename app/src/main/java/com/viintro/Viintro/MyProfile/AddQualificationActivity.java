...
public class AddQualificationActivity extends Activity {
    ...
    private void initialiseUI()
    {
        ...
        if(getIntent().getExtras() != null) {
            String qual = getIntent().getExtras().getString("qual");
            if (!(qual == null)) {
                edt_qualification.setText(qual);
            }
        }

        edt_qualification.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        btn_saveInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(CommonFunctions.chkStatus(mContext))
                {
                    ...
                    req_add_qualifications_API(mContext);
    ...
    //API call to send qualification data
    public void req_add_qualifications_API(final Context cont)
    {
        ...
        String url = m_config.web_api_link+ "/add-qualifications";
        ...
        try
        {
            ...
            obj.put("qualifications", edt_qualification.getText().toString().replaceAll("\\s+", " ").trim());  //m_config.profile_website
        ...
        JsonObjectRequest getRequest = new JsonObjectRequest(Request.Method.POST, url, obj,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        CommonFunctions.hDialog();
                        CommonFunctions.displayToast(context,"Qualification details has been saved");
                        if(profile_qualifications_list.size() == 0)
                        {
                        ...
                        String qualification = edt_qualification.getText().toString().replaceAll("\\s+", " ").trim();
                        profile_qualifications_list = new ArrayList();
                        profile_qualifications_list.add(Arrays.asList(qualification.split(",")));
                        Intent resultIntent = new Intent();
                        resultIntent.putExtra("qualification", qualification);
                        ...
                        if(error.networkResponse != null) {
                            ...
                            if (error.networkResponse.statusCode == 500) {
                                ...
                                if (networkresponse_data != null) {
                                    ...
                                    {
                                        CommonFunctions.displayToast(context, context.getResources().getString(R.string.Qualification_details_failed));
                                    }
        ...
        ViintroApplication.getInstance().addToRequestQueue(getRequest, "add_qualifications_api");
