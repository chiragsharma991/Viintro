...
public class BlockUserAPI {
    ...
    //api to block user
    public static void req_block_user_API(final Context cont, BlockUser_Request blockUser_request, final int position, final String from_Activity)
    {
        ...
        String url = m_config.web_api_link+ "/block";
        ...
        try
        {
            ...
            obj.put("blocked_user_id", blockUser_request.getBlocked_user_id());
            obj.put("reason", blockUser_request.getReason());
                            ...
                            if(error.networkResponse.statusCode == 500)
                            {
                                ...
                                if (networkresponse_data != null) {
                                    ...
                                    try {
                                        ...
                                        CommonFunctions.displayToast(context, context.getResources().getString(R.string.Block_user_failed));
                                    }
        ...
        ViintroApplication.getInstance().addToRequestQueue(getRequest, "block_user_api");



    }

    private static void condition(Context context, String from_Activity, int position, String msg_block) {
        if(from_Activity.equals("Public_Profile"))
        {
            PublicProfileActivity publicProfileActivity = (PublicProfileActivity) context;
            publicProfileActivity.update_menu_title(position,"block", msg_block);
        }
