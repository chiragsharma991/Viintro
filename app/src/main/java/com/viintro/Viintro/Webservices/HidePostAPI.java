...
public class HidePostAPI {


    //api call to hide post
    public static void req_post_hide_API(Context cont, PostReport_Request postReport_request, final int position, final String from_Activity) {
        ...
        String url = m_config.web_api_link_header+ "/posts/hide";
                        ...
                        if(error.networkResponse != null)
                        {
                            ...
                            if(error.networkResponse.statusCode == 500)
                            {
                                ...
                                if(networkresponse_data != null)
                                {
                                    ...
                                    {
                                        CommonFunctions.hDialog();
                                        CommonFunctions.displayToast(context,context.getResources().getString(R.string.Post_hide_failed));
                                    }
        ...
        ViintroApplication.getInstance().addToRequestQueue(getRequest, "post_hide_api");
