...
public class Intro_VideoAPI
{

    // API Call for profile video
    public static void req_intro_video_API(final Context cont, ProfileIntro_Video_Request profileVideo_request)
    {
        ...
        m_config.queue = Volley.newRequestQueue((Activity) context);
        final Gson gson = new Gson();
        String url = m_config.web_api_link+ "/profile/intro-video";
        ...
        JsonObjectRequest profilevideorequest = new JsonObjectRequest(Request.Method.POST, url, obj,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if(response.getBoolean("intro") == true)
                            {
                                ...
                                if(m_config.from_activity_record_video.equals("edit_intro_video"))
                                {
                                    MyProfileFragment myProfileFragment = new MyProfileFragment();
                                    intro_video_myprofile = gson.fromJson(response.toString(),Videos.class);
                                    Log.e("thumbnail","== "+intro_video_myprofile.getThumbnail());
                                    myProfileFragment.editIntroVideo();
                                }
                                else
                                {
        ...
        ViintroApplication.getInstance().addToRequestQueue(profilevideorequest, "intro_video_api");
