...
/**
 * Created by rkanawade on 14/02/17.
 */

public class ResendOtpAPI {


    //api call forq resend otp
    public static void req_resend_API(Context cont, Otp_Request otp_request) {
        ...
        String url = m_config.web_api_link_header+ "/otp/resend";
        ...
        ViintroApplication.getInstance().addToRequestQueue(getRequest, "resend_otp_api");
