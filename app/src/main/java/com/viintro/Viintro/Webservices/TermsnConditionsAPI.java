...
/**
 * Created by rkanawade on 24/04/17.
 */

public class TermsnConditionsAPI {

    public static void req_termsncond_API(final Context cont)
    {
        ...
        String url = "http://dev.viintro.com/app-terms-of-service";
        ...
        ViintroApplication.getInstance().addToRequestQueue(request, "terms_conditions_api");
