...
public class UnfollowAPI {
    ...
    public static void req_Unfollow_request_API(Context cont, int user_id, final int position, final String from_Activity) {
        ...
        String url = m_config.web_api_link+ "/unfollow";
                            ...
                            if(error.networkResponse.statusCode == 500)
                            {
                                ...
                                if (networkresponse_data != null) {
                                    ...
                                    try {
                                        ...
                                        CommonFunctions.displayToast(context, context.getResources().getString(R.string.Unfollow_request_failed));
                                    }
        ...
        ViintroApplication.getInstance().addToRequestQueue(getRequest, "unfollow_api");
    ...
    private static void condition(Context context, String from_Activity, int position)
    {
        if(from_Activity.equals("MyFollowers"))
        {
            ...
            followersActivity.onRowUpdate(position, "unfollow");

            MyProfileFragment myProfileFragment = new MyProfileFragment();
            myProfileFragment.updatefollowingcount(context, "unfollow");

        }
        else if(from_Activity.equals("MyFollowings"))
        {
            MyFollowingsActivity followingsAdapter = new MyFollowingsActivity();
            followingsAdapter.onRowUpdate(position, "unfollow");
        ...
        else if(from_Activity.equals("Public_Profile"))
        {
            ...
            //publicProfileActivity.upd_btn_in_pub_prof_after_conn_follow_unfollow(position, "unfollow");
            publicProfileActivity.update_menu_title(position,"unfollow","");
        ...
        else if(from_Activity.equals("WhoViewed"))
        {
            ...
            whoViewedProfileActivity.onRowUpdate(position,"unfollow");
