...
public class YouTubeAPI
{
    ...
    public static void req_youtue_upload(Context cont, Youtube_Request youtube_request) {
        ...
        try
        {
            obj.put("client_id", youtube_request.getClient_id());
            obj.put("client_secret", youtube_request.getClient_secret());
            obj.put("description", youtube_request.getDescription());
            obj1.put("type",youtube_request.getVideo().getType());
            obj1.put("source_default",youtube_request.getVideo().getSource_default());
            obj1.put("source_hls",youtube_request.getVideo().getSource_hls());
            obj1.put("source_mpd",youtube_request.getVideo().getSource_mpd());
            obj1.put("thumbnail",youtube_request.getVideo().getThumbnail());
            obj1.put("public_id",youtube_request.getVideo().getPublic_id());
            obj.put("video", obj1);
        ...
        ViintroApplication.getInstance().addToRequestQueue(getRequest, "you_tube_api");
